...
void PositionMatrix::paintEvent(QPaintEvent *)
{
    ...
    QColor position_block_color(0, 0, 0);
    QColor white_number_color(255,255,255);
    ...
    const QRect rect = QRect(-33, -33, 66, 66);
    ...
    painter.translate(QPoint(-132,66));
    ...
    painter.setBrush(position_block_color);
    ...
    case 1:
        ...
        painter.setPen(white_number_color);
        painter.drawText(rect, Qt::AlignCenter, "1");
        break;
